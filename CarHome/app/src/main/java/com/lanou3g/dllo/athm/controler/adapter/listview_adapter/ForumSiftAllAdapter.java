...
public class ForumSiftAllAdapter extends BaseAdapter {
    ...
    //set方法,将行布局数据传入
    public void setDatas(List<ForumSiftAllBean> datas) {
        this.datas = datas;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ForumSiftAllBean bean = (ForumSiftAllBean) getItem(position);
        viewHolder.coutentTv.setText(bean.getCoutent());
        viewHolder.titleTv.setText(bean.getTitle());
        viewHolder.countTv.setText(bean.getCount());
        viewHolder.iv.setImageResource(bean.getImgId());
        //将设置好的行布局返回给系统
        return convertView;
    }
