 ...
 */
public class FindHeadLkAdapter extends RecyclerView.Adapter<FindHeadLkAdapter.MyViewHolder>{
    private Context context;
    private List<FindBean.ResultBean.ModulelistBean.ListBean> datas;

    public FindHeadLkAdapter(Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //布局初始化  从context获得一个布局加载器 加载布局 因为加载布局的方法是Activity才可以 所以利用context
         View view = LayoutInflater.from(context).inflate(R.layout.item_find_head_lk_rc, parent, false);
        //把布局里面的数据赋值缓存类里面
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            gdLogo = (ImageView) itemView.findViewById(R.id.item_find_head_lk_logo_iv);
            titleTv = (TextView) itemView.findViewById(R.id.item_find_head_lk_title_tv);
            contentTv = (TextView) itemView.findViewById(R.id.item_find_head_lk_content_tv);
            moneyTv = (TextView) itemView.findViewById(R.id.item_find_head_lk_money_tv);
            money2Tv = (TextView) itemView.findViewById(R.id.item_find_head_lk_money2_tv);
