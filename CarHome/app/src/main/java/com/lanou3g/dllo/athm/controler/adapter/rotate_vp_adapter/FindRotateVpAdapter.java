...
public class FindRotateVpAdapter extends PagerAdapter{
    ...
    public void setRotateDatas(List<FindRotateBean> rotateDatas) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        FindRotateBean bean = rotateDatas.get(newPosition);
        View converView = inflater.inflate(R.layout.find_coming,container,false);
        ImageView imageView = (ImageView) converView.findViewById(R.id.item_find_iv);
